...
'https://akorlar.com/ara/aa',
'https://akorlar.com/ara/ab',
  ...
  for (const targetUrl of urls) {
    ...
    try {
      ...
      const songLinks = await page.evaluate(() => {
        ...
        return anchors
          .map(a => a.href)
          .filter(href => href.includes('akorlar.com/') && !href.includes('/kategori/') && !href.includes('/iletisim') && href.split('/').length > 3);
      });
